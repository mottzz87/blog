...
大致意思为，TypeScript 是一种基于JavaScript构建的强类型编程语言，可在任何规模上为您提供更好的工具
...
本篇文章主要目的是为了让大家快速熟悉typescript在vue3里的使用，下来将介绍一些 `Typescript` 的基本使用
